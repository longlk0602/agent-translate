...
class AzureTranslator(BaseTranslator):
    ...
    def translate_text(
        self, text: str, target_lang: str = None, source_lang: str = None
    ) -> str:
        ...
        try:
            ...
            response = self.client.translate(
                content=input_text_elements, to=[target], from_parameter=source_lang
            )
    ...
    def translate_texts(
        self, texts: List[str], target_lang: str = None, source_lang: str = None
    ) -> List[str]:
