...
class TranslationMonitor:
    ...
    async def health_check(self) -> Dict[str, Any]:
        ...
        checks["openai_available"] = self.agent.translation_engine.openai_engine is not None
        checks["anthropic_available"] = self.agent.translation_engine.anthropic_engine is not None
    ...
    def get_metrics(self) -> Dict[str, Any]:
        ...
        processing_times = [result.processing_time for result in self.agent.translation_history]
    ...
    def _calculate_error_rate(self) -> float:
        ...
        total_errors = sum(len(result.errors) for result in self.agent.translation_history)
